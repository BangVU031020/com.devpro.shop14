...
<body>
								...
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a
											href="${base }/admin/category">Category</a></li>
							...
							<div class="content ml-3">
								...
								<sf:form method="POST" action="${base }/admin/add-category"
									...
									<div class="form-group">
										...
										<sf:select path="parent.id" class="form-control"
											id="parent">
									...
									<div class="form-group">
										<label for="createdDate">createdDate (Required)</label>
										<sf:input type="text" path="createdDate" class="form-control" id="createdDate" ></sf:input>
									</div>

									<div class="form-group">
										<label for="name">Name (Required)</label>
										<sf:input path="name" class="form-control" id="name"
											placeholder="Name" required="required"></sf:input>
									</div>

									<div class="form-group">
										<label for="description">Description</label>
										<sf:textarea rows="4" path="description" class="form-control"
											id="description" placeholder="Description"></sf:textarea>
									</div>
									
									<div class="form-group">
										<label for="status">Trạng Thái</label>
										<sf:checkbox path="status" id="status"/>
									</div>
										
									
									<div class="row mt-3">
										<div class="col-md-2">
											<a href="${base }/manager/category"><button type="button"
	...
	<script>
	 $( function() {
		    $( "#createdDate" ).datepicker({ dateFormat: 'dd/mm/yy' });
	});
	</script>
</body>
