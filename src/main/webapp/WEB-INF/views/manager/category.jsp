			...
			<div class="row mt-3">
				...
				<div class="col-md-10">
					<div class="view bg-light text-dark">
							...
							<div class="col-md-8">
								<div class="title">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											<li class="breadcrumb-item"><a href="${base }/admin/category">Category</a></li>
						...
						<div class="row">
							<div class="col-md-12"><h3><a href="${base }/admin/add-category">Add Category</a></h3></div>
							<div class="col-md-12">
									...
									<table cellspacing= 0 class="tblview" >
										...
										<c:forEach var="category" items="${categories }">
											<tr>
												...
												<td class ="DEC" >${category.description }</td>
												<td class ="STATUS" >${category.parent.name }</td>
												<td class="ED" ><a href="${base }/admin/edit-category/${category.id }"><i class="fas fa-edit"></i></a></td>
												<td class="ED" ><a href="${base }/admin/del-category/${category.id }"><i class="fas fa-trash"></i></a></td>
